...
func (uc *UserCreate) AddUserConfigIDs(ids ...int) *UserCreate {
	uc.mutation.AddUserConfigIDs(ids...)
	return uc
}
...
func (uc *UserCreate) AddUserConfigs(u ...*UserConfig) *UserCreate {
	...
	return uc.AddUserConfigIDs(ids...)
}
...
func (uc *UserCreate) AddUserTomatoIDs(ids ...int) *UserCreate {
	uc.mutation.AddUserTomatoIDs(ids...)
	return uc
}
...
func (uc *UserCreate) AddUserTomatoes(u ...*UserTomato) *UserCreate {
	...
	return uc.AddUserTomatoIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.UserConfigsIDs(); len(nodes) > 0 {
	...
	if nodes := uc.mutation.UserTomatoesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
